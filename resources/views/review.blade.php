...
@section('content')
    ...
    <section id="review">
        ...
        <div class="container comsec">
            <div class="row who">
                <div class="col-md-12">
                    <p class="posted"><span>Nakano Miku</span>&nbsp;commented on 12 Mar. 2019 :</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"><img class="rounded-circle img-fluid" src="assets/img/cover.jpg" width="150"></div>
                <div class="col-md-8 contentcom">
                    <p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.<br></p>
                    <p><strong>Saya sangat puas dengan layanan Fusions Visual.</strong></p>
                    <p><strong>Nakano Miku&nbsp;</strong>- Company Name<br></p>
                </div>
            </div>
        </div>
        <div class="container comsec">
            <div class="row who">
                <div class="col-md-12">
                    <p class="posted"><span>Nakano Ichika</span>&nbsp;commented on 13 Mar. 2019 :</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"><img class="rounded-circle img-fluid" src="assets/img/cover.jpg" width="150"></div>
                <div class="col-md-8 contentcom">
                    <p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.<br></p>
                    <p><strong>Saya sangat puas dengan layanan Fusions Visual.</strong></p>
                    <p><strong>Nakano Ichika&nbsp;</strong>- Company Name<br></p>
                </div>
            </div>
        </div>
        <div class="container comsec">
            <div class="row who">
                <div class="col-md-12">
                    <p class="posted"><span>Nakano Nino</span>&nbsp;commented on 12 Mar. 2019 :</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"><img class="rounded-circle img-fluid" src="assets/img/cover.jpg" width="150"></div>
                <div class="col-md-8 contentcom">
                    <p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.<br></p>
                    <p><strong>Saya sangat puas dengan layanan Fusions Visual.</strong></p>
                    <p><strong>Nakano Nino&nbsp;</strong>- Company Name<br></p>
                </div>
            </div>
        </div>
        <div class="container comsec">
            <div class="row who">
                <div class="col-md-12">
                    <p class="posted"><span>Nakano Yotsuba</span>&nbsp;commented on 13 Mar. 2019 :</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"><img class="rounded-circle img-fluid" src="assets/img/cover.jpg" width="150"></div>
                <div class="col-md-8 contentcom">
                    <p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.<br></p>
                    <p><strong>Saya sangat puas dengan layanan Fusions Visual.</strong></p>
                    <p><strong>Nakano Yotsuba&nbsp;</strong>- Company Name<br></p>
                </div>
            </div>
        </div>
        {{--        pagination--}}
